...
public class GameConstants {
	...
	private static final long[] exp = {//Updated Table
    ...
    public static boolean Demon(final int job) {
        return job == 3000 || (job >= 3100 && job <= 3112);
    }
    
    public static boolean ExPlorer(final int job) {
        
        return job == 0 || (job >= 100 && job <= 512);
    }
    ...
    public static boolean isThunderBreaker(final int job) { //woops xD:3
        return job == 1500 || (job >= 1510 && job <= 1512);
    }
...
//    }
    ...
    public static boolean isDemon(int job) {
        return (job == 3100) ||(job >= 3110 && job <= 3112);
    }
    ...
    public static boolean isWildhunter(final int job) {
        return job == 3300 || (job >= 3300 && job <= 3312);
    }

    public static boolean isBatllemage(final int job) {
    ...
    public static boolean isMech(final int job){
        return job == 3500 || (job >= 3510 && job <= 3512);
    }
